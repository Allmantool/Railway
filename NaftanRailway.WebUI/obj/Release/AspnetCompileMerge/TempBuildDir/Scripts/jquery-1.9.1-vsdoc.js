...
(function (window, undefined) {
    ...
    jQuery.ajax = function (url, options) {
        ...
        // and/or If-All-Match header later on
        cacheURL = s.url;
        ...
        // Set the If-Modified-Since and/or If-All-Match header, if in ifModified mode.
        if (s.ifModified) {
            if (jQuery.lastModified[cacheURL]) {
                jqXHR.setRequestHeader("If-Modified-Since", jQuery.lastModified[cacheURL]);
            }
            if (jQuery.etag[cacheURL]) {
                jqXHR.setRequestHeader("If-All-Match", jQuery.etag[cacheURL]);
            }
        }
